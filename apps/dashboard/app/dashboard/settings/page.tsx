...
import {
  Key, Github, Copy, Check, ExternalLink, Code2, ChevronDown, LogOut, BookOpen, Video, Zap, CreditCard,
} from 'lucide-react'
...
function SettingsContent() {
  ...
  const [usage, setUsage] = useState<{ plan: string; events: { used: number; limit: number }; ai: { used: number; limit: number } } | null>(null)
